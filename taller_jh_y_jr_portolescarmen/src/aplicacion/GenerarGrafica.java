...
public class GenerarGrafica extends JPanel implements ActionListener {
	public static final String INFORME = "clientesgrafica.jasper";
	...
	public static JasperPrint generarInforme() {
		try {
			...
			JasperPrint grafica = JasperFillManager.fillReport(INFORME, null, Conexion.getMySQLConexion());
	...
	public void actionPerformed(ActionEvent e) {
		JasperPrint graficoClientes=generarInforme();
		JasperViewer viewer = new JasperViewer(graficoClientes, false);
		viewer.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		viewer.setVisible(true);
		try {
			JasperExportManager.exportReportToPdfFile(graficoClientes, "Grafico_Portoles.pdf");
